...
namespace MPAS.WebUI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public void setAnnouncement(string returnUrl)
        {
            System.Diagnostics.Debug.Write("test");

            Announcement announcement = new Announcement();
            announcement.Id = 1;
            announcement.postDate = new DateTime(1/1/2016);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, FormCollection collection)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        userId = db.Users.Find(user.Id).Id;
                    }
                    var role = collection.Get("role");
                    //if (role == "Mentor")
                    //{
                    ...
                    //    //database.table.add(object attributes)
                    //    db.Professors.Add(x);
                    //}
                    //else if(role=="Mentee")
                    //{
